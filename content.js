(() => {
  ...
  const styles = `
    ...
    * { box-sizing: border-box; }
    ...
    #panel { position:fixed; z-index:2147483647; display:none; width:320px; max-height:calc(100vh - 16px); overflow-x:hidden; overflow-y:auto; pointer-events:auto; border:1px solid #484840; border-radius:5px; background:#1b1c1a; box-shadow:0 14px 38px rgba(0,0,0,.46), inset 0 1px rgba(255,255,255,.025); color:#f3efe7; font-family:Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; }
    #panel::before { display:none; }
    .panel-head { padding:13px 12px 11px; border-bottom:1px solid #373832; background:#1a1b19; }.element-state { display:flex; align-items:center; gap:7px; margin-bottom:9px; color:#aaa59b; font-size:10px; line-height:1; }.element-state span { width:6px; height:6px; border:1px solid #77736c; transform:rotate(45deg); }.element-state span.is-locked { border-color:#f1b84a; background:#f1b84a; box-shadow:0 0 8px rgba(241,184,74,.3); }.element-state b { margin-left:auto; color:#75716a; font:500 9px/1 ui-monospace, SFMono-Regular, Menlo, monospace; text-transform:uppercase; }.selector-line { display:flex; align-items:center; gap:8px; min-width:0; }.selector { min-width:0; overflow:hidden; color:#f1ece3; font:500 12px/1.25 ui-monospace, SFMono-Regular, Menlo, monospace; text-overflow:ellipsis; white-space:nowrap; }.selector b { color:#f1b84a; font-weight:500; }.text-preview { overflow:hidden; margin-top:8px; color:#aaa59b; font-size:11px; line-height:1.3; text-overflow:ellipsis; white-space:nowrap; }.resource-copy { flex:none; height:24px; padding:0 7px; cursor:pointer; color:#ddd7cc; border:1px solid #4a4b45; border-radius:3px; background:#292a27; font:500 9px/1 ui-monospace, SFMono-Regular, Menlo, monospace; white-space:nowrap; }.resource-copy:hover, .resource-copy:focus-visible { outline:none; color:#f1b84a; border-color:rgba(241,184,74,.65); background:#302d24; }.resource-copy:disabled { cursor:progress; opacity:.55; }.resource-copy.is-copied { color:#1a1812; border-color:#f1b84a; background:#f1b84a; }.resource-copy.is-failed { color:#ffb4ab; border-color:#b95f56; background:#4a2d2a; }
    .property-section { border-bottom:1px solid #373832; }.property-section summary { display:flex; align-items:center; min-height:36px; padding:0 12px; cursor:pointer; list-style:none; color:#e8e2d8; font-size:11px; font-weight:600; user-select:none; }.property-section summary::-webkit-details-marker { display:none; }.property-section summary::before { width:0; height:0; margin-right:9px; content:""; border-top:4px solid transparent; border-bottom:4px solid transparent; border-left:5px solid #f1b84a; transform:rotate(90deg); transition:transform .14s ease; }.property-section:not([open]) summary::before { transform:rotate(0); }.property-body { padding:0 8px 10px; }.metric-grid { display:grid; grid-template-columns:1fr 1fr; gap:6px; margin:0 4px 8px; }.metric-field { display:grid; grid-template-columns:15px 1fr auto; align-items:center; height:28px; padding:0 7px; border:1px solid #33342f; border-radius:3px; background:#222320; }.metric-field span { color:#8f8b83; font-size:10px; }.metric-field b { overflow:hidden; color:#e8e2d8; font-size:11px; font-weight:400; text-overflow:ellipsis; white-space:nowrap; }.metric-field small { color:#75716a; font-size:9px; }.property-row { display:grid; grid-template-columns:88px minmax(0,1fr); align-items:center; min-height:28px; padding:0 7px; border-radius:3px; font-size:11px; }.property-row:hover { background:#292a27; }.property-label { overflow:hidden; color:#aaa59b; text-overflow:ellipsis; white-space:nowrap; }.property-value { overflow:hidden; color:#eee8de; text-align:left; text-overflow:ellipsis; white-space:nowrap; }.property-value.colour { display:grid; grid-template-columns:16px minmax(0,1fr) auto auto; gap:6px; align-items:center; }.colour-swatch { display:block; width:16px; height:16px; border:1px solid rgba(255,255,255,.18); border-radius:2px; background-image:linear-gradient(45deg,#555 25%,transparent 25%),linear-gradient(-45deg,#555 25%,transparent 25%),linear-gradient(45deg,transparent 75%,#555 75%),linear-gradient(-45deg,transparent 75%,#555 75%); }.property-value small { color:#8f8b83; font-size:9px; }.property-value em { overflow:hidden; color:#8f8b83; font-size:9px; font-style:normal; text-overflow:ellipsis; white-space:nowrap; }
    #detail-tooltip { position:fixed; z-index:2147483647; display:none; max-width:min(300px, calc(100vw - 24px)); padding:7px 9px; pointer-events:none; border:1px solid #464740; border-radius:3px; background:#141513; box-shadow:0 8px 22px rgba(0,0,0,.42); color:#eee8de; font:10px/1.45 ui-monospace, SFMono-Regular, Menlo, monospace; white-space:pre-line; overflow-wrap:anywhere; }
  `;
